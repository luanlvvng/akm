...
<html>
    <head>
        <title><?php echo 'Tư  vấn cùng chuyên gia'; ?></title>
    ...
    <body class="expert " data-base-url="<?php echo $this->url->get(); ?>" data-debug="">
        <div id="wrap-all">
            <div id="wrap-header">
            ...
            <div class="content">
                ...
                <div class="visible-animation3">
                    ...
                    <ul class="faqlist">
                        ...
                        <li><a href="<?php echo $this->url->get(array('for' => 'faq-view', 'slug' => $faq['slug'], 'id' => $faq['id'])); ?>"><h3><?php echo $faq['question']; ?></h3></a></li>
                        <?php } ?>
                    </ul>
